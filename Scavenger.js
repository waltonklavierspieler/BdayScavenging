...
const clueKey = [
    {q: 'Question 1.\nYou need to find the one very short, charming brick road in the Southernmost part of Mapleton Hills.\nOn that road there are 6 houses whose house numbers face the brick portion of the street. Sum them together, and what do you get?', ans: ['2584'], hint: 'Find Mountainview Road, and 4th Street. The first and last house numbers are 409 and 449...'},
    {q: 'Great job! Question 2.\nNext, head to the local over-priced convenience/grocery store on West Pearl. The store\'s logo has a fruit where one of the \'O\'s should be:\nWhat fruit is it?', ans: ['apple'], hint: 'One of these a day keeps the doctor away'},
    {q: 'Apples!! Okay, Question 3.\nSomewhere between the bike store and paper store is a statue of a boy playing with a dog.\nHow many of the dogs legs are ON the ground?', ans: ['3', 'three'], hint: 'Think tripod.'},
    ...
    {q: 'Good ol Picasso, yep! I think you have earned yourself a drink at this point. Head to Beleza and get yourself a latte, my treat, with this gift card number: 7782 7305 9710 4984. PIN: 1399. (Or, if they have closed already, save this for later!)\nWhen that\'s done, head to the shady part of North Boulder Park and someone you know will give you the passcode...', ans: ['chicken', 'chicken!'], hint: 'Not a trick question: go get some coffee then go to the park!'}
    // Add more clues here
    ...
    resetScreen.innerHTML = `
        <div class="startScreen">
            <h1 id="introduction">HAPPY BIRTHDAY BOO! 
                ...
                <br>
                It should take about an hour to complete on foot. You will need only your phone!
                <br>
...
function showEndScreen() {
    ...
    endScreen.innerHTML = `
        <div class="endScreen">
            ...
            <button id="resetButton">Back to the Beginning</button>
        </div>
    `;
